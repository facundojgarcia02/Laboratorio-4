...
class PT100:
    ...
    @staticmethod
    def get_poly(filename: str = "files/Pt100_resistencia_temperatura.csv"):
        """
    ...
    @staticmethod
    def get_errorcoeff(filename: str = "files/Pt100_resistencia_temperatura.csv"):
        """
    ...
    @staticmethod
    def get_errorpoly(filename: str = "files/Pt100_resistencia_temperatura.csv"):
        """
        ...
        popt = get_errorcoeff(filename) #Consigo los coefiencientes del polinomio "interpolador"
